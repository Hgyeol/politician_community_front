...
22대 국회의원을 지도에서 탐색하고, 정치인별로 건의사항과 댓글을 공유할 수 있는 시민 참여형 커뮤니티입니다. Nuxt 3 + Supabase를 활용해 인증부터 게시판까지 풀스택 기능을 제공하며, 지도 서비스를 인터랙티브하게 재구성했습니다.
...
| gc-board는 필터링 및 검색 기능이 없어 원하는 게시글을 빠르게 찾기 어려웠음 | 카테고리 기반 필터와 키워드 검색 기능을 추가하고, 무한 스크롤을 적용해 사용자가 목적에 맞는 게시글을 효율적으로 탐색할 수 있도록 개선 |
